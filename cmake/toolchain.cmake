...
if(WIN32 OR USE_EXE_SUFFIX)
	set(TOOLCHAIN_EXEC_SUFFIX .exe CACHE INTERNAL "GCC EXECUTABLE SUFFIX")
else()
	set(TOOLCHAIN_EXEC_SUFFIX "" CACHE INTERNAL "GCC EXECUTABLE SUFFIX")
endif()
...
#set(CMAKE_C_FLAGS "-fno-omit-frame-pointer" CACHE INTERNAL "CMAKE C FLAGS")
